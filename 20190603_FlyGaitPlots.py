...
specs = {
          ...
          'STANCE_DURATION'   :   {'PLOT':'BOX', 'ENTITIES':legs, 'YLIMS':(0, 200), 'YLABEL':'ms', 'TITLE':'Stance Duration', 'sSize': 1, 'sAlpha':0.3},
...
#ax[legendAxesRowSet,legendAxesColSet].legend(handles=legendPatches,bbox_to_anchor=(legendHorPos, legendVerPos), ncol=2).draggable()
plt.show()
