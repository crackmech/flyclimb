...
baseDir = '/media/aman/data/flyWalk_data/tmp_climbing/CS1/tmp_20171201_195931_CS_20171128_0245_11-Climbing_male (3rd copy)/imageData/'
        ...
        if len(centroids)>skpdFramesThresh:
            ...
            for i,trk in enumerate(threshTrackFrNum):
                ...
                if brkPts!=[]:
                    ...
                    print cnts- centroids, brkPts, skpdFramesThresh
                else:
                    print 'no breakpts found', csvName
                    cnts = centroids
                ...
                print  np.sum(instanDis), csvName
                ...
                print '---------', iF,i, trackStopDelT, trk, skpdFramesThresh, '---------'
                trackNumber+=1
