...
ctrl = 'tracksFolders_W1118_'
exp1 = 'tracksFolders_W1118xLrrk-ex1'
exp2 = 'tracksFolders_Park25xLrrk-ex1'
...
#csvCtrl = baseDir+'W1118_legTracking_WALK_SPEED_dict.csv'
#csvExp1 = baseDir+'W1118xLrrk-ex1_legTracking_WALK_SPEED_dict.csv'
#csvExp2 = baseDir+'Park25xLrrk-ex1_legTracking_WALK_SPEED_dict.csv'
#dataCtrl = readCsv(csvCtrl)
#dataExp1 = readCsv(csvExp1)
#dataExp2 = readCsv(csvExp2)
...
allStats = []
allStats.append(['',ctrl+' x '+exp1, ctrl+' x '+exp2, exp1+' x '+exp2])
...
csvOutFile = baseDir+'gaitStats.csv'
...
rma = getRMAnova(concRestrucData[0], dataSets, True)
