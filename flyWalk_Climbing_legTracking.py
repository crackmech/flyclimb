...
imDuration = 6      #in minutes
startSegment = 0
totalLoops = 1    #total number of times the imaging loop runs
fps = 250
extension = '.png'
...
displayScale = 2
framedelThreshMin = 1  #for centroid tracking use value=1, for leg tracking use value=1
framedelThreshMax = 10
avgWeight = 0.01#0.001
avg = None
dirThresh = 250
printFrameSD = False #set to true to print the SD of the image being displayed, used to set thresholds
